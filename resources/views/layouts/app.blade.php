...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/toogle.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ URL::asset('css/font-awesome.css') }}">

    <!-- Theme style -->
    <link rel="stylesheet" href="{{ URL::asset('css/adminlte.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/all-skin.min.css') }}">
...
@else
    ...
    <script src="{{ URL::asset('js/momment.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/check.js') }}"></script>
