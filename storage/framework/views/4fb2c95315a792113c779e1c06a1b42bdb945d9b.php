  ...
  <div class="row">
   ...
   <div class="panel panel-primary col-sm-12 col-md-4">
    ...
    <div class="panel-body">
      ...
      <form method="post" action="<?php echo e(url('/check_history')); ?>">
        ...
        <div class="form-group">
          ...
          <select id='selUser' name="patient" class="form-control">
            ...
            <option value="<?php echo e($row->patient_id); ?>">(<?php echo e($row->patient_id); ?>) <?php echo e($row->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nhisacc\resources\views/presHistory.blade.php ENDPATH**/ ?>