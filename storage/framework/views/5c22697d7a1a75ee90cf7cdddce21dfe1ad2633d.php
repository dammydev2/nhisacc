<li><a href="<?php echo e(url('patient')); ?>">Patient Registration</a></li>
<li><a href="<?php echo e(url('consultation')); ?>">Consultation (Prescription)</a></li>
<li><a href="<?php echo e(url('drug')); ?>">Drugs</a></li>
<li><a href="<?php echo e(url('service')); ?>">NHIS service (charges)</a></li>
